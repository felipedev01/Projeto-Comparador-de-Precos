...
function HomeScreen({ navigation }) {
  return (
    <View style={{ /*marginTop: Constants.statusBarHeight,*/ flex: 1 }}>
      <View style={{ backgroundColor: '#FFDD00', height: '10%', alignItems: 'center', justifyContent: 'center', paddingTop:14}}><Text style={{ color: 'black', fontSize: 30, fontWeight: 'bold',fontStyle:'italic' }}>Comparador de Preços</Text></View>
      <View style={{ backgroundColor: '#FFDD00', paddingHorizontal: '5%', paddingTop: 15 }}><Text style={{color: 'black', fontSize: 25, textAlign: 'center',fontWeight:'50' }}>Crie sua lista e compare preços entre supermercados da sua cidade, compre pelo melhor preço</Text></View>
 ...
 function inserirprodutos(){
  ...
  if(tela=='tela2'){
    ...
    return(
      <View style={{/* marginTop: Constants.statusBarHeight,*/paddingTop:14,flex: 1, backgroundColor: '#FFDD00', }}>
     <View style={{ flexDirection: 'row', backgroundColor: 'white', marginTop: 10, height: 40,  borderTopColor: 'gray', borderTopWidth: 1,width:'100%' }}>
          <Text style={{ fontSize: 22, color: 'gray', width: '90%', paddingLeft: 28, paddingTop: 5,textAlign:'center' }}>Selecione um Supermercado</Text>
      ...
      }}onPress={()=>prosseguir1()}><Text style={{color:'white',paddingLeft:10,paddingTop:5,fontSize:22}}>Prosseguir</Text></TouchableOpacity>
  ...
  if(tela=='tela3'){
    ...
    return(
      <View style={{paddingTop:14, flex: 1, backgroundColor: '#FFDD00', }}>
        ...
        <View style={{ flexDirection: 'row', backgroundColor: 'white', marginTop: 10, marginHorizontal: 60, height: 40, borderRadius: 50, borderColor: 'gray', borderWidth: 1,position:'relative',top:-50 }}>
          ...
          <Picker style={{ width: '30%', paddingLeft: 80, height: '100%',backgroundColor:'transparent' }}
    ...
    if(tela=='tela3.1'){
      ...
      return(
        <View style={{ paddingTop:25, flex: 1, backgroundColor: '#FFDD00', }}>
  ...
  if(tela=='tela4'){
    return(
      ...
      <ScrollView style={{flex: 1, backgroundColor: '#FFDD00',height:100,
      width:"100%",paddingTop:20
       ...
       <ImageBackground source={image} style={{width:200,height:50,marginTop:5,marginBottom:5,flexDirection:'row'}}>
        ...
        textAlign:'center',paddingTop:15,fontWeight:'bold'}}>R$ {parseFloat(total.replace(',','.'))}</Text></View>
        </View>
        }
        {
         avenida &&
